        ...
        <Col xs={12} md={6}>
          <Card className="custom-card" style={{padding: "20px", margin: "20px"}}>
            <Card.Body>
              ...
              <Button className="border-primary text-primary cardbtn1">Connect</Button>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col xs={12} md={6}>
          <Card className="custom-card" style={{padding: "20px", margin: "20px"}}>
            <Card.Body >
              ...
              <Button className="border-primary text-primary cardbtn2">Meet up</Button>
            </Card.Body>
          </Card>
        </Col>
      </Row>
        ...
        <Col xs={12} md={6}>
          <Card className="custom-card" style={{padding: "20px", margin: "20px"}}>
            <Card.Body>
              ...
              <Button className="border-primary text-primary cardbtn3">Get it</Button>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col xs={12} md={6}>
          <Card className="custom-card" style={{padding: "20px", margin: "20px"}}>
            <Card.Body>
              ...
              <Button className="border-primary text-primary cardbtn4">Attend</Button>
            </Card.Body>
          </Card>
        </Col>
      </Row>
